package com.king.countfetalmovement.baseadapter;
...
public class BaseAdapterHelper
{
	...
	{
		ImageView view = retrieveView(viewId);
		//Picasso.with(context).load(imageUrl).into(view);  //King
//		ImageLoader.getInstance().displayImage(imageUrl,view,new ImageLoadingListener() {
//			@Override
